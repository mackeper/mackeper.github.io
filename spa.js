...
var $author$project$Main$DevTools = function (a) {
	return {$: 'DevTools', a: a};
};
var $author$project$Main$DevToolsMsg = function (a) {
	return {$: 'DevToolsMsg', a: a};
};
var $author$project$Main$GamesCS = function (a) {
	return {$: 'GamesCS', a: a};
};
...
var $author$project$Main$UsernameGeneratorMsg = function (a) {
	return {$: 'UsernameGeneratorMsg', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Pages$About$About$Model = F2(
	function (property, property2) {
		return {property: property, property2: property2};
	});
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Pages$About$About$init = _Utils_Tuple2(
	A2($author$project$Pages$About$About$Model, 0, 'modelInitialValue2'),
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$getNouns = {isUsed: false, items: $author$project$Pages$UsernameGenerator$Nouns$getNouns, name: 'Nouns'};
var $author$project$Pages$UsernameGenerator$UsernameGenerator$getAllCategories = _List_fromArray(
	[$author$project$Pages$UsernameGenerator$UsernameGenerator$getAdjectives, $author$project$Pages$UsernameGenerator$UsernameGenerator$getAnimals, $author$project$Pages$UsernameGenerator$UsernameGenerator$getCoolNumbers, $author$project$Pages$UsernameGenerator$UsernameGenerator$getNouns]);
var $author$project$Pages$UsernameGenerator$UsernameGenerator$initialModel = {
	categories: $author$project$Pages$UsernameGenerator$UsernameGenerator$getAllCategories,
	numberOfResults: 5,
	seed: $elm$random$Random$initialSeed(42),
	usernames: _List_Nil
};
var $author$project$Pages$UsernameGenerator$UsernameGenerator$init = _Utils_Tuple2($author$project$Pages$UsernameGenerator$UsernameGenerator$initialModel, $author$project$Pages$UsernameGenerator$UsernameGenerator$getGenerator);
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$initTo = F3(
...
var $author$project$Main$initCurrentPage = function (_v0) {
	...
	var _v1 = function () {
		...
		switch (_v2.$) {
			...
			case 'About':
				return A3($author$project$Main$initTo, $author$project$Main$About, $author$project$Main$AboutMsg, $author$project$Pages$About$About$init);
			case 'Blog':
				return A3($author$project$Main$initTo, $author$project$Main$Blog, $author$project$Main$BlogMsg, $author$project$Pages$Blog$Blog$init);
			case 'DevTools':
				return A3($author$project$Main$initTo, $author$project$Main$DevTools, $author$project$Main$DevToolsMsg, $author$project$Pages$Dev$Tools$Tools$init);
			default:
				return A3($author$project$Main$initTo, $author$project$Main$GamesCS, $author$project$Main$GamesCSMsg, $author$project$Pages$Games$CS$CS$init);
		}
	}();
	...
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[existingCmds, pageCmd])));
};
var $author$project$Route$NotFound = {$: 'NotFound'};
var $author$project$Route$About = {$: 'About'};
var $author$project$Route$Blog = {$: 'Blog'};
var $author$project$Route$DevTools = {$: 'DevTools'};
var $author$project$Route$GamesCS = {$: 'GamesCS'};
var $author$project$Route$Home = {$: 'Home'};
var $author$project$Route$UsernameGenerator = {$: 'UsernameGenerator'};
...
var $author$project$Route$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$GamesCS,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('games'),
				$elm$url$Url$Parser$s('cs'))),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$UsernameGenerator,
			$elm$url$Url$Parser$s('usernamegenerator'))
		]));
...
var $author$project$Pages$About$About$update = F2(
	function (msg, model) {
		if (msg.$ === 'Msg1') {
...
var $author$project$Pages$Blog$Blog$update = F2(
	function (msg, model) {
		if (msg.$ === 'Msg1') {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
...
var $author$project$Pages$Dev$Tools$Tools$update = F2(
	function (msg, model) {
		if (msg.$ === 'Msg1') {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$getConcatinatedCategories = F2(
	function (categories, seed) {
		...
		if (!_v0.b) {
			...
			if (!_v0.b.b) {
				...
				return A2(
					$elm$random$Random$step,
					$elm_community$random_extra$Random$List$shuffle(head.items),
					seed);
			} else {
				var head = _v0.a;
				var tail = _v0.b;
				...
				var words = _v1.a;
				var newSeed = _v1.b;
				var _v2 = A2($author$project$Pages$UsernameGenerator$UsernameGenerator$getConcatinatedCategories, tail, newSeed);
				var words2 = _v2.a;
				var newSeed2 = _v2.b;
				return _Utils_Tuple2(
					A3(
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$getRandomUsernames = F2(
	function (categories, seed) {
		return A2($author$project$Pages$UsernameGenerator$UsernameGenerator$getConcatinatedCategories, categories, seed).a;
	});
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$updateCategoryIsUsed = F2(
			...
			F2(
				function (i, category) {
					return _Utils_eq(i, index) ? _Utils_update(
						category,
						{isUsed: !category.isUsed}) : category;
				}),
			model.categories);
	});
var $author$project$Pages$UsernameGenerator$UsernameGenerator$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							usernames: A2(
								...
								A2($author$project$Pages$UsernameGenerator$UsernameGenerator$getRandomUsernames, model.categories, model.seed))
						}),
					$author$project$Pages$UsernameGenerator$UsernameGenerator$getGenerator);
			case 'GetNewSeed':
				var value = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							seed: $elm$random$Random$initialSeed(value)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var index = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							categories: A2($author$project$Pages$UsernameGenerator$UsernameGenerator$updateCategoryIsUsed, model, index)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$updateTo = F4(
	function (model, toModel, toMsg, _v0) {
		var subModel = _v0.a;
		var subCmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
				...
				case 'UrlChanged':
					...
					return $author$project$Main$initCurrentPage(
						_Utils_Tuple2(
							...
							$elm$core$Platform$Cmd$none));
				case 'UsernameGeneratorMsg':
					if (_v0.b.$ === 'UsernameGenerator') {
						var subMsg = _v0.a.a;
						var pageModel = _v0.b.a;
						return A4(
							$author$project$Main$updateTo,
							model,
							$author$project$Main$UsernameGenerator,
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$ToggleCategory = function (a) {
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$viewCategories = function (categories) {
	return A2(
		$elm$core$List$indexedMap,
		F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$checked(category.isUsed),
									$elm$html$Html$Events$onClick(
									$author$project$Pages$UsernameGenerator$UsernameGenerator$ToggleCategory(index))
								]),
							_List_Nil),
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$viewUsername = function (username) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Pages$UsernameGenerator$UsernameGenerator$viewUsernames = function (usernames) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Pages$UsernameGenerator$UsernameGenerator$viewUsername, usernames));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_List_Nil,
				$author$project$Pages$UsernameGenerator$UsernameGenerator$viewCategories(model.categories)),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Pages$UsernameGenerator$UsernameGenerator$GenerateUsername)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Generate username')
					])),
				$author$project$Pages$UsernameGenerator$UsernameGenerator$viewUsernames(model.usernames)
			]));
};
	...
	switch (_v0.$) {
		...
		case 'About':
			...
			return A2(
				$elm$html$Html$map,
				$author$project$Main$AboutMsg,
				$author$project$Pages$About$About$view(aboutModel));
		case 'Blog':
			var pageModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$BlogMsg,
				$author$project$Pages$Blog$Blog$view(pageModel));
		case 'DevTools':
			var pageModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$DevToolsMsg,
				$author$project$Pages$Dev$Tools$Tools$view(pageModel));
		case 'GamesCS':
			var pageModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$GamesCSMsg,
				$author$project$Pages$Games$CS$CS$view(pageModel));
		default:
			var usernameGeneratorModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$UsernameGeneratorMsg,
				$author$project$Pages$UsernameGenerator$UsernameGenerator$view(usernameGeneratorModel));
	}
};
